...
<body>
				...
				<div class="nav-collapse collapse">
					...
					<div class="pull-right">
						<ul class="nav pull-right">
							...
							<li class="dropdown"><!-- Identificarme (login) -->
    ...
    <div class="container"><!--container-->     
		<div class="row-fluid"><!--row-fluid-->
					...
					<div class="carousel slide media-carousel" id="media">
						<div class="carousel-inner">
						  <div class="item  active">
							<div class="row">
							  <div class="col-md-4">
								<a class="thumbnail" href="#"><img alt="" src="img/64040.jpg"></a>
							  </div>               
							</div>
						  </div>
						  <div class="item">
							<div class="row">
							  <div class="col-md-4">
								<a class="thumbnail" href="#"><img alt="" src="img/puerto-rico-coffee.jpg"></a>
							  </div>                
							</div>
						  </div>
						  <div class="item">
							<div class="row">
							  <div class="col-md-4">
								<a class="thumbnail" href="#"><img alt="" src="img/verduras.jpg"></a>
							  </div>           
							</div>
						  </div>
						</div>
			...
			<!-- Fin de Imagenes movibles del index -->
		</div><!--/.row-fluid-->
		<hr><!--Linea divisoria-->
		<div class="row-fluid"><!-- Columnas de Recien Productos y Compañias -->
			<div class="span5">
				<h4>Productos Recien Añadidos</h4>
				<?php while($row_prod = mysql_fetch_array($query_prod)){  ?>
			...
			<div class="span5">
			    ...
			    <?php while($row_user = mysql_fetch_array($query_users)){ ?>
				<p><a href="view_profile.php?company_id=<?php echo $row_user['profile_id'];?>"><?php echo $row_user['company_name']?></a></p>
				<?php } ?>
			</div>
		</div><!-- Fin de Columnas de Recien Productos y Compañias -->
		<hr><!--Linea para dividir-->
